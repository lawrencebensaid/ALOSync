...
public class Resource: ResourceModel, Decodable, ObservableObject {
    ...
    public enum `Type`: String, Codable {
        ...
        public var systemImage: String { Resource.systemImages[self] ?? "questionmark" }
    }
    ...
    init(fid: String? = nil, name: String, type: `Type`, subtype: Subtype? = nil, size: Int64? = nil, course: Course? = nil, depth: Int = 1, children: [Resource]? = nil) {
        self.id = fid ?? UUID().uuidString
        self.fid = fid
        self.name = name
        self.type = type
    ...
    required public init(from decoder: Decoder) throws {
        ...
        self.children = try container.decodeIfPresent([Resource].self, forKey: .children)
    }
